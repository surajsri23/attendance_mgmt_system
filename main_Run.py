...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec.destroy, fg="black", bg="lawn green", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='dheeraj036', db='manually_fill_attendance')
        ...
        if subb == '':
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'C:\Users\Public\Documents\Attendance Management System using Face Recognition\Attendance\Manually Attendance\"')
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='dheeraj036', db='Face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = r'C:\Users\Public\Documents\Attendance Management System using Face Recognition' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"C:\Users\Public\Documents\Attendance Management System using Face Recognition\Attendance\"')
